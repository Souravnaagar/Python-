...
Heading = Label(root, bg="white",text = "Welcome to youtube\nDownloader Application",font=("Arial Bold", 20)).pack(fill=X)
...
Entry(root, textvariable=myVar, width=40).pack(pady=30)
# declaring StringVar type variable
link = StringVar()
# created the Entry widget to get the link
Entry(root, textvariable=link, width=40).pack(pady=10)
# created and called the download function to download video
Button(root, text="Download video",bg = "black", fg = "white",height="3 ",width="37", command=download).pack()
